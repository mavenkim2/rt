...
OIDN_NAMESPACE_BEGIN
  ...
  public:
    ...
    BufferRef newBuffer(ExternalMemoryTypeFlag handleType, void* ptr, const void* name, size_t byteSize) const
    {
      return oidnNewSharedBufferFromWin32Handle(
        this->handle, static_cast<OIDNExternalMemoryTypeFlag>(handleType), ptr, name, byteSize);
    }
