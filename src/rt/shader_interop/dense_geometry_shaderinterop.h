...
#define MAX_CLUSTER_VERTICES_BIT 14
#define MAX_CLUSTER_VERTICES     (1 << MAX_CLUSTER_VERTICES_BIT)

#define MAX_CLUSTER_TRIANGLE_VERTICES_BIT 9
#define MAX_CLUSTER_TRIANGLE_VERTICES     (1 << MAX_CLUSTER_TRIANGLE_VERTICES_BIT)

#define MAX_BRICKS_PER_TEMPLATE 21
